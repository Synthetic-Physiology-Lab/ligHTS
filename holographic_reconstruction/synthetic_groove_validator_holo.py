...
synthetic_groove_generator_holo.py
"""
...
def _read_truth_index(truth_csv: Path) -> List[SyntheticSample]:
    # Read the truth_index.csv generated by synthetic_groove_generator_holo.py
...
def _analyze_one(
    ...
    *,
    ...
    # An analyzer that returned an in-band error dict is an error.
